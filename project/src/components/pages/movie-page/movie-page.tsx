            ...
            <div className="film-card__desc">
              ...
              <div className="film-card__text">
                <p>
                  ...
                  Zero, a junior lobby boy, becomes Gustave&rsquo;s friend and protege.
                </p>
                <p>
                  Gustave prides himself on providing first-class service to the
                  hotel&rsquo;s guests, including satisfying the sexual needs of the many
                  elderly women who stay there. When one of Gustave&rsquo;s lovers dies
